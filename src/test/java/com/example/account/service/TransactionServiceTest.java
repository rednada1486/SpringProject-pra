...
class TransactionServiceTest {
    ...
    void successUseBalance() {
        ...
        TransactionDto transactionDto = transactionService
                .useBalance(1L, "1234567890", 1000L);
    ...
    @Test
    @DisplayName("해지 계좌 - 잔액 사용 실패")
    void deleteAccountFailed_accountAlreadyDelete() {
        //given
        AccountUser pobi = AccountUser.builder()
                .name("Pobi")
                .build();
    ...
    void useBalanceFailed_AmountExceed() {
        ...
        AccountException exception = assertThrows(AccountException.class,
                () -> transactionService.useBalance(1L, "1234567890", 100000L));
    ...
    void successCancelBalance() {
        ...
        TransactionDto transactionDto = transactionService
                .cancelBalance("transactionId", "1234567890", CANCEL_AMOUNT);
    ...
    void cancelBalanceFailed_TransactionAmountUnMatch() {
        //given
    ...
    @Test
    @DisplayName("1년 이전의 거래  - 잔액 사용 취소 실패")
    void cancelBalanceFailed_toOldCase() {
        //given
        ...
        Transaction transaction = Transaction.builder()
                ...
                .transactionResultType(S)
                .transactionId("transactionID")
                .transactedAt(LocalDateTime.now().minusDays(366))
                .amount(CANCEL_AMOUNT)
                .balanceSnapshot(9000L)
                .build();
    ...
    void successQueryTransaction() {
        ...
        Transaction transaction = Transaction.builder()
                ...
                .transactionResultType(S)
                .transactionId("transactionID")
                .transactedAt(LocalDateTime.now().minusDays(364))
                .amount(CANCEL_AMOUNT)
                .balanceSnapshot(9000L)
                .build();
        //given
        ...
        TransactionDto transactionDto = transactionService.queryTransaction("asfdas");
