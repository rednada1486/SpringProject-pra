...
public class AccountService {
    ...
    public AccountDto createAccount(Long userId, Long initialBalance) {
        ...
        return AccountDto.fromEntity(accountRepository.save(Account.builder().accountUser(accountUser).accountStatus(IN_USE).accountNumber(newAccountNumber).balance(initialBalance).registeredAt(LocalDateTime.now()).build()));
    ...
    public List<AccountDto> getAccountsByUserId(Long userId) {
        ...
        return accounts.stream()
                .map(AccountDto::fromEntity) // fromEntity가 Account받아서 AccountDto로 반환해줌
